...
b2.pack(side=LEFT,anchor="nw",padx=10)
...
b5.pack(side=BOTTOM,anchor="nw",padx=10)
b6=Button(button_label,text="   6   ",fg="red")
b6.pack(side=BOTTOM,anchor="nw",padx=10)
b7=Button(button_label,text="   7   ",fg="red")
b7.pack(side=BOTTOM,anchor="nw",padx=10)
b8=Button(button_label,text="   8   ",fg="red")
b8.pack(side=BOTTOM,anchor="ne",padx=10)
